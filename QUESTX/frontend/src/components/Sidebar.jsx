  ...
  return (
    <div className={`flex flex-col ${isCollapsed ? 'w-20' : 'w-64'} ${darkMode ? 'bg-gray-800' : 'bg-gray-100'} transition-all duration-300 ease-in-out`}>
      ...
      <ul className="flex flex-col py-4">
        ...
        <li>
          <Link to="/feedback" className={`flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 ${darkMode ? 'text-gray-300 hover:text-white' : 'text-gray-600 hover:text-gray-800'} hover:text-white`}>
            <span className={`inline-flex items-center justify-center h-12 w-12 text-lg ${darkMode ? 'text-gray-300 hover:text-white' : 'text-gray-600 hover:text-gray-800'}`}>
