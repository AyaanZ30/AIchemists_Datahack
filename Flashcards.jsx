      ...
      {showResult && (
        <div className="text-center">
          <div className={`text-xl font-bold mb-4 ${
            selectedOption === flashcards[currentCard].correctOption ? 'text-green-500' : 'text-red-500'
          }`}>
            {selectedOption === flashcards[currentCard].correctOption ? 'You are Right!' : 'You are Wrong!'}
          </div>
